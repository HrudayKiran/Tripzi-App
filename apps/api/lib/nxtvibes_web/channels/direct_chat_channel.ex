defmodule NxtVibesWeb.DirectChatChannel do
  ...
  @impl true
  def join("dm:" <> chat_id, _params, socket) do
    user_id = socket.assigns.current_user_id

    case Chats.get_direct_chat(chat_id) do
      %DirectChat{participants: participants} = _chat ->
      ...
      {:ok, message} ->
        ...
        case Chats.get_direct_chat(chat_id) do
          %DirectChat{participants: participants} = chat ->
            ...
            recipient_id = Enum.find(participant_ids, &(&1 != user_id))
